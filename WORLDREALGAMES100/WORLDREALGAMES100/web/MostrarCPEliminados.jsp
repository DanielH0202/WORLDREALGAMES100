        ...
        <form id="frmMostrarCuerpoCPEliminados">
            <table id="tablaMostrarCuerpoCPEliminados">
                ...
                <tr>
                    ...
                    <td class="Opcion">
                        <input type="button" name="btnRecuperar" id="btnRecuperar" class="button" value="Habilitar" onclick="location.href='Servlet_CP?codigoCP=<%=CP.getCodigoCP() %>&&accion=recuperar'">
                    </td>
                </tr>
