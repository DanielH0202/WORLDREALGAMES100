        ...
        <form id="frmMostrarCuerpoProd">
            <table id="tablaMostrarCuerpoProd">
                ...
                <tr>
                    ...
                    <td class="Opcion">
                        <input type="button" name="btnEliminar" id="btnEliminar" class="button" value="Inhabilitar" onclick="location.href='Servlet_Prod?codigoP=<%=P.getCodigoP() %>&&accion=eliminar'">
                    </td>
                </tr>
