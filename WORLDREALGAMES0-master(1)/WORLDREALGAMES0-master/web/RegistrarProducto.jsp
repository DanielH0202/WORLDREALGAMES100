    ...
    <form name="frm" action="Servlet_Prod" method="post" id="frmRegistrarProd">
        <table id="tablaRegistrarProd">
            ...
            <tr>
                ...
                <td>
            <dd> <select type="text" name="txtClase" id="txtClase" class="textBox"> </dd>
            <option>selecciona:</option>
                    <%
                        ps = con.prepareStatement("select * from  clase_producto");
                        rs = ps.executeQuery();
                             while (rs.next()) {%>
                             <option> <%=rs.getString("Nombre_CP")%></option>
                    <%}%>
        </select>
            </td>
            </tr>
            <tr>
                ...
                <td>
            <dd> <select type="text" name="txtMarca" id="txtMarca" class="textBox">

                    <option>selecciona:</option>
                    <%
                        ps = con.prepareStatement("select * from  marca_producto");
                        rs = ps.executeQuery();
                             while (rs.next()) {%>
                             <option> <%=rs.getString("Nombre_MP")%></option>
                    <%}%> 
