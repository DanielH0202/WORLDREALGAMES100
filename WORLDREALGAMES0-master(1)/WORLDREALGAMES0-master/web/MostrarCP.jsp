        ...
        <form id="frmMostrarCuerpoCP">
            <table id="tablaMostrarCuerpoCP">
                ...
                <tr>
                    ...
                    <td class="Opcion">
                        <input style="color: lightcoral" type="button" name="btnModificar" value="Modificar" id="btnModificar" class="button" onclick="location.href='ModificarCP.jsp?codigoCP=<%=CP.getCodigoCP() %>&&nombreCP=<%=CP.getNombreCP() %>&&estadoCP=<%=CP.getEstadoCP() %>'">
                    </td>
