...
public class Servlet_Prod extends HttpServlet {
    ...
    private void RegistrarProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("RegistrarProducto.jsp?mens='Se ha registrado un producto correctamente'"); 
        }else{
            response.sendRedirect("RegistrarProducto.jsp?mens='El registro ya existe'"); 
        }
    }
    ...
    private void ActualizarProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("MostrarProducto.jsp?mens='Se ha modificado el producto "+p.getCodigoP()+"'"); 
        }else{
            response.sendRedirect("MostrarProducto.jsp?mens='Error al modificar el producto'"); 
        }
    }
    ...
    private void DarBajaProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("MostrarProducto_1.jsp?mens='Se ha inhabilitado el producto "+p.getCodigoP()+"'"); 
        }else{
            response.sendRedirect("MostrarProducto_1.jsp?mens='No se puede eliminar el producto existente'"); 
        }
    }
    ...
    private void DarAltaProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("MostrarProductosEliminados.jsp?mens='Se ha recuperado el producto "+p.getCodigoP()+"'"); 
        }else{
            response.sendRedirect("MostrarProductosEliminados.jsp?mens='Error al recuperar el producto'"); 
        }
    }
