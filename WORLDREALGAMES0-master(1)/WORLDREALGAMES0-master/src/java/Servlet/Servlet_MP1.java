 ...
 * @author Daniel
 */
public class Servlet_MP1 extends HttpServlet {
    ...
    private void RegistrarMarcaProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("MostrarMP2.jsp?mens='Se ha registrado una marca de producto correctamente'"); 
        }else{
            response.sendRedirect("MostrarMP2.jsp?mens='Error al registrar la marca'"); 
        }
    }
    ...
    private void ActualizarMarcaProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("MostrarMP2.jsp?mens='Se ha modificado la marca producto "+mp.getCodigoMP()+"'"); 
        }else{
            response.sendRedirect("MostrarMP2.jsp?mens='Error al modificar la marca producto'"); 
        }
    }
    ...
    private void darBajaMarcaProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("MostrarMP2.jsp?mens='Se ha Inhabilitado la marca producto "+mp.getCodigoMP()+"'"); 
        }else{
            response.sendRedirect("MostrarMP2.jsp?mens='Error al Inhabilitar la marca producto'"); 
        }
    }
    ...
    private void darAltarMarcaProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("MostrarMP2.jsp?mens='Se ha recuperado la marca producto "+mp.getCodigoMP()+"'"); 
        }else{
            response.sendRedirect("MostrarMP2.jsp?mens='Error al recuperar la marca producto'"); 
        }
    }
